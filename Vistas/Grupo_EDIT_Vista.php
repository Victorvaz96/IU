...
?>
 <?php
			...
			echo "<form class=\"form-horizontal\" method=\"post\" action=\"..\Controlador\Grupo_Controller.php?ModificarGrupo\">";
			...
			echo "</div></div>";
			echo "<a href=\"Grupo_Controller.php?ModificarGrupo\"><input type=\"image\" src=\"..\Archivos\\lapiz.png\" width=\"20\" height=\"20\"></a>";
			echo "</fieldset>";
			echo "</form>";
