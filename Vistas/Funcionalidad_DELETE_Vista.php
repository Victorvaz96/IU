...
?>
 <?php
			...
			echo "<form class=\"form-horizontal\" method=\"post\" action=\"..\Controlador\Funcionalidad_Controller.php?BajaFuncionalidad\">";
			...
			echo "</div></div>";
			echo "<a href=\"Funcionalidad_Controller.php?BajaFuncionalidad\"><input type=\"image\" src=\"..\Archivos\\eliminar.png\" width=\"20\" height=\"20\"></a>";
			echo "</fieldset>";
			echo "</form>";
