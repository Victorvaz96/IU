...
?>
 <?php
			...
			echo "<form class=\"form-horizontal\" method=\"post\" action=\"..\Controlador\Funcionalidad_Controller.php?ModificarFuncionalidad\">";
			...
			echo "</div></div>";
			echo "<a href=\"Funcionalidad_Controller.php?ModificarFuncionalidad\"><input type=\"image\" src=\"..\Archivos\\lapiz.png\" width=\"20\" height=\"20\"></a>";
			echo "</fieldset>";
			echo "</form>";
